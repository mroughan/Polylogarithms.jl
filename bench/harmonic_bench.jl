...
##############################################
# integer arguments
data1 = CSV.read("../data/harmonic_test_data_1.csv")
m = size(data1,1)
H1 = zeros(Float64, m)
...
##############################################
# real arguments
data2 = CSV.read("../data/harmonic_test_data_2.csv")
m = size(data2,1)
H2 = zeros(Float64, m)
...
Hr = Symbol("Re(H(z))")
Hi = Symbol("Im(H(z))")
data3 = CSV.read("../data/harmonic_test_data_3.csv")
m = size(data3,1)
...
data4 = CSV.read("../data/harmonic_test_data_4.csv")
m = size(data4,1)
H4 = zeros(Float64, m)
...
H = Symbol("real(H_{n,r})")
data5 = CSV.read("../data/harmonic_test_data_5.csv")
m = size(data5,1)
H5 = zeros(Float64, m)
